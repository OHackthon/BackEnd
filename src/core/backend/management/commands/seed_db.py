...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # 3. Create Items with Real Photos (using Unsplash source for demo purposes)
        # Note: In a real scenario, we would have specific URLs.
        # Using generic "museum object" keywords for variety.
        ...
        items_data = [
            {
                ...
                "estado": "BOM",
                "inteireza": "INTEIRO",
                "img_url": "https://images.unsplash.com/photo-1599940824399-b87987ce0799?q=80&w=800&auto=format&fit=crop",  # Stone texture/object
            ...
            },
            {
                ...
                "estado": "REGULAR",
                "inteireza": "PARCIAL",
                "img_url": "https://images.unsplash.com/photo-1610701596007-11502861dcfa?q=80&w=800&auto=format&fit=crop",  # Pottery
            ...
            },
            {
                ...
                "estado": "BOM",
                "inteireza": "INTEIRO",
                "img_url": "https://images.unsplash.com/photo-1516962215378-7fa2e137ae93?q=80&w=800&auto=format&fit=crop",  # Arrowhead lookalike
            ...
            },
            {
                ...
                "estado": "BOM",
                "inteireza": "INTEIRO",
                "img_url": "https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?q=80&w=800&auto=format&fit=crop",  # Shells
            ...
            },
            {
                ...
                "estado": "BOM",
                "inteireza": "INTEIRO",
                "img_url": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=800&auto=format&fit=crop",  # Stone bowl/mortar
            ...
            },
            {
                ...
                "img_url": "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=800&auto=format&fit=crop",  # Statue
